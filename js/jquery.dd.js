...
;(function($) { 
   ...
   var dd = function(element, options)
   {
	...
	var createA = function(currentOptOption, current, currentopt, tp) {
		...
		//alert("el id es " + aid);
		//alert("el índice es " + currentOptOption.index);
		var innerStyle = getOptionsProperties(currentOptOption);
		if(matchIndex(currentOptOption.index)==true) {
		 //aTag += '<a href="javascript:void(0);" onclick="alert(\'interno\');" class="'+styles.selected+' '+sEnabledClass+clsName+'"';
		 aTag += '<a href="javascript:void(0);" onclick="'+options.userFunction+'" class="'+styles.selected+' '+sEnabledClass+clsName+'"';
		
		} else {
		//aTag += '<a  href="javascript:void(0);" onclick="alert(\'interno\');" class="'+sEnabledClass+clsName+'"';
		aTag += '<a  href="javascript:void(0);" onclick="'+options.userFunction+'" class="'+sEnabledClass+clsName+'"';
		};
