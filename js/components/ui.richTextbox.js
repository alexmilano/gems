    ...
    return this.each( function() {
        ...
        function toolbar() {
            var tb = $("<div class='rte-toolbar' id='toolbar-"+ element_id +"'><div>\
                <p>\
                    <a href='#' class='bold'><img src='"+opts.media_url+"bold.gif' alt='bold' border='0' /></a>\
                    <a href='#' class='italic'><img src='"+opts.media_url+"italic.gif' alt='italic' border='0' /></a>\
                    <a href='#' class='unorderedlist'><img src='"+opts.media_url+"unordered.gif' alt='unordered list' border='0' /></a>\
                    <a href='#' class='link'><img src='"+opts.media_url+"link.png' alt='link' border='0' /></a>\
                    <a href='#' class='disable'><img src='"+opts.media_url+"close.gif' alt='close rte' border='0' /></a>\
                </p></div></div>");
